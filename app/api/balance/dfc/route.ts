...
export async function GET(req: Request) {
  try {
    ...
    const grupoMap: Record<string, string> = {
      IND: 'DF Individual - Demonstração do Fluxo de Caixa (Método Indireto)',
      CON: 'DF Consolidado - Demonstração do Fluxo de Caixa (Método Indireto)',
    };
      ...
      return NextResponse.json(
        {
          ...
          params: { denomCia, grupoDfp, periodo },
        },
        { status: 400 },
      );
    }
